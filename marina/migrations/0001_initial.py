    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marina.especiemarina')),
            ],
        ),
        migrations.CreateModel(
            name='PerfilUsuario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amenaza', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marina.amenazamarina')),
                ('contaminante', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marina.contaminante')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('especie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='marina.especiemarina')),
                ('habitat', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='marina.habitatmarino')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateTimeField(auto_now_add=True)),
                ('logro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marina.logro')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
